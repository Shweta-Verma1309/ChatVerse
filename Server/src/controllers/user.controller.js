...
export async function sendFriendRequest(req, res) {
  try {
    ...
    try {
        console.log("Attempting to send friend request notification...")

      await streamClient.sendCustomEvent(recipientId, {
      ...
      console.error("Stream event failed to send:", eventError.message);
    }
